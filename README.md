...
**Unora — Make time, together.**

A calm, AI-assisted group planning app for real-world connection.

Unora is a private, invite-only, mobile-first web app designed to help small groups of friends fairly decide when and where to meet offline — and quietly preserve shared memories afterward.
...
* **Frontend:** React + Tailwind + ShadCN (mobile-first UI)
...
`react` `fastapi` `mongodb` `openai` `ai` `product-design` `social-app` `startup`
